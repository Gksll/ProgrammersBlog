...
namespace Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> Get(int categoryId)
        {
            ...
            return new DataResult<CategoryDto>(data: null, ResultStatus.Error, message: "Böyle bir kategori yok");
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAll()
        {
            ...
            return new DataResult<CategoryListDto>(null, ResultStatus.Error, "Hiçbir kategori bulunamadı");
        }
        ...
        public async Task<IResult> Delete(int categoryId, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Error, "Böyle bir kategori nesnesi bulunamadı");
        }
